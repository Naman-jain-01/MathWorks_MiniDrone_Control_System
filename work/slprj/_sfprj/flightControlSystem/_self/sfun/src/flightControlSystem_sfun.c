  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(instanceChksum, "sD0UzmdVc2IyOwHPRKwY0p") == 0) {
     ...
     case 6:
      {
        if (strcmp(instanceChksum, "sKgnjfdN0b3jJOmzQi4YwgH") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(tpChksum, "sD0UzmdVc2IyOwHPRKwY0p") == 0) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "sKgnjfdN0b3jJOmzQi4YwgH") == 0) {
